    ...
    <>
      ...
      <section className="bg-neutral-950 text-white py-20 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-30%] right-[-10%] w-[50%] h-[80%] bg-gradient-to-bl from-purple-500/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-[-20%] left-[-5%] w-[40%] h-[70%] bg-gradient-to-tr from-cyan-400/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
        </div>
      ...
      <section className="bg-neutral-900 py-16 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[-30%] left-[20%] w-[40%] h-[80%] bg-gradient-to-br from-purple-500/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-[-20%] right-[10%] w-[35%] h-[70%] bg-gradient-to-tl from-cyan-400/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
        </div>
