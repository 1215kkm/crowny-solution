    ...
    <>
      ...
      <section className="bg-neutral-950 text-white py-20 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="aurora-blob-1 absolute top-[-30%] right-[-10%] w-[50%] h-[80%] bg-gradient-to-bl from-purple-500/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
          <div className="aurora-blob-2 absolute bottom-[-20%] left-[-5%] w-[40%] h-[70%] bg-gradient-to-tr from-cyan-400/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
        </div>
            ...
            {[
              ...
              <div key={item.phase} className="flex gap-6 items-start">
                <div className="flex flex-col items-center">
                  <div className={`w-10 h-10 rounded-[3px] flex items-center justify-center text-sm font-bold ${i === 0 ? "bg-gradient-to-br from-cyan-400/[0.3] via-neutral-900 to-neutral-900 text-white" : "bg-neutral-200 text-neutral-500"}`}>
                    {i + 1}
                  </div>
      ...
      <section className="bg-neutral-900 py-16 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="aurora-blob-2 absolute top-[-30%] left-[20%] w-[40%] h-[80%] bg-gradient-to-br from-purple-500/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
          <div className="aurora-blob-1 absolute bottom-[-20%] right-[10%] w-[35%] h-[70%] bg-gradient-to-tl from-cyan-400/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
        </div>
