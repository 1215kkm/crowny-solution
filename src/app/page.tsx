    ...
    <>
      ...
      <section className="bg-neutral-950 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="aurora-blob-1 absolute top-[-20%] left-[-10%] w-[60%] h-[80%] bg-gradient-to-br from-cyan-400/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
          <div className="aurora-blob-2 absolute top-[10%] right-[-10%] w-[50%] h-[70%] bg-gradient-to-bl from-purple-500/[0.3] via-transparent to-transparent rounded-full blur-3xl" />
